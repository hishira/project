...
export const SelectTestValues: string[] = ['Test 1', 'Test 2', 'Test 3'];
export const SelectTestValidators: ValidatorFn[] = [Validators.email];
export const SelectPipeGroupValues = [
  'customer',
  'manager',
  'supplier',
  'other',
];
export const TranslatedGroupsValues = [
  'Klient',
  'Menadżer',
  'Dostawca',
  'Inny',
