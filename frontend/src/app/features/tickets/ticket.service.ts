  ...
  private mockTickets: TicketListItem[] = [
    {
      ...
      description: 'Użytkownik nie może się zalogować przez SSO. Występuje błąd 401 przy autoryzacji.',
      type: 'crm',
      status: 'in_progress',
      priority: 'high',
    ...
    },
    {
      ...
      description: 'Podczas generowania raportu miesięcznego występuje błąd zapisu do bazy danych.',
      type: 'pm',
      status: 'doing',
      priority: 'critical',
    ...
    },
    {
      ...
      description: 'Partner wymaga dostępu do REST API dla integracji systemów.',
      type: 'crm',
    ...
    },
    {
      ...
      description: 'Należy zaktualizować dokumentację techniczną po ostatnich zmianach w API.',
      type: 'pm',
      status: 'todo',
      priority: 'low',
    ...
    },
    {
      ...
      description: 'Klient prosi o możliwość eksportu raportów do formatu PDF.',
      type: 'crm',
      status: 'resolved',
      priority: 'medium',
    ...
    },
    {
      ...
      description: 'Serwer zwraca błąd 500 podczas przesyłania plików większych niż 10MB.',
      type: 'pm',
      status: 'in_progress',
      priority: 'high',
    ...
    },
    {
      ...
      description: 'Potrzebny nowy widok dashboard z podsumowaniem dla kadry zarządzającej.',
      type: 'pm',
      status: 'doing',
      priority: 'medium',
