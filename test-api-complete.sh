...
# Sports Diary API Test Script - Complete Endpoint Testing
...
# Start testing
echo -e "${BLUE}🚀 Starting Comprehensive API Endpoint Tests${NC}"
...
# Clean up - try to delete the activity if we created one
if [ ! -z "$ACTIVITY_ID" ]; then
    print_header "Cleanup"
    echo "Note: Logout may have invalidated token, cleanup might fail"
